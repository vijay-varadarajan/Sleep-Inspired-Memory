"""Run PERSONACHAT evaluation with existing memory/agent/sleep backend."""
...
from personachat_postprocessing import save_results_tables
from utils.api_counter import get_api_counters, reset_api_counters


class PersonaChatRunner:
    """Simple benchmark runner for PERSONACHAT data."""
    ...
    def __init__(
        ...
        output_dir: str = "personachat_results",
        ...
        self.data_dir = Path("PERSONACHAT/preprocessed")
    ...
    def run_table1_evaluation(self, method: str) -> Dict[str, Any]:
        ...
        agent = create_agent(method, dataset_name="personachat", ablation_flags=self.ablation_flags)
    ...
    def run(self) -> Dict[str, Any]:
        ...
        raw_path = self.output_dir / f"personachat_results_{timestamp}.json"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run PERSONACHAT benchmark")
    parser.add_argument(
        "--split",
        type=str,
        default="validation",
    ...
    parser.add_argument("--output_dir", type=str, default="personachat_results", help="Result output folder")
    parser.add_argument(
        "--ablation",
        type=str,
        default="none",
